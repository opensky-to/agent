...
namespace OpenSky.AgentMSFS.Models
{
    ...
    public class SimbriefWaypointMarker : Canvas
    {
        ...
        /// -------------------------------------------------------------------------------------------------
        /// <summary>
        /// Gets waypoint marker for saving to a file.
        /// </summary>
        /// <remarks>
        /// sushi.at, 01/04/2021.
        /// </remarks>
        /// <returns>
        /// The waypoint marker for saving.
        /// </returns>
        /// -------------------------------------------------------------------------------------------------
        public XElement GetWaypointMarkerForSave()
        {
            var waypointElement = new XElement("Waypoint");
            waypointElement.SetAttributeValue("Lat", $"{this.GeoCoordinate.Latitude}");
            waypointElement.SetAttributeValue("Lon", $"{this.GeoCoordinate.Longitude}");
            waypointElement.SetAttributeValue("Name", $"{this.WaypointName}");
            waypointElement.SetAttributeValue("Type", $"{this.WaypointType}");
