...
namespace OpenSkyApi
{
    ...
    public partial class OpenSkyService : OpenSkyServiceBase
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<DataImportStatusApiResponse> StatusAsync(System.Guid? importID)
        {
            return StatusAsync(importID, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<DataImportStatusApiResponse> StatusAsync(System.Guid? importID, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/DataImport/status?");
            if (importID != null) 
            {
